...
* **🚨 超重要ルール：ハートビート完了の強制**
  * **思考ログ作成後の再編集・上書きを固く禁止**
  * ファイル名がタイムスタンプのため、ログ作成＝そのハートビートサイクルの記録確定
  * **ログ作成後は追加作業をしてもログに残せないため、必ずタスク完了して次のハートビートに移行すること**
  * 万が一思考ログを編集する必要が出てしまった場合は、編集ではなくファイル名に連番を付与して別名ファイルの新規作成で対応してください。
