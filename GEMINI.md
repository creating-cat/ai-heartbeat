...
* 内省活動：これまでの振り返りを行い、思考履歴の要約や比較を実施し、進化度・新規性・方向性やテーマの逸脱がないか自己評価する。
* その他活動：上記以外の何かしらの活動
...
**テーマ移行時**: `ai-docs/THEME_HISTORY_GUIDE.md`に従ってテーマ選択・履歴記録・themebox管理を実行すること（過去に読み込んだ内容に依存せず、ツールを使用して最新の内容を確認してください）
