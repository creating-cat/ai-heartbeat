...
* プロンプトを受け取った時に、現在のモードを判定し、「〇〇モードで動作します」と宣言する。
...
* **入力：** ユーザーのプロンプト
* **出力：** 入力に応答した回答（思考ログの作成・記録は不要）。
* **テーマ受け取り時：** 新しいテーマが与えられた場合は、`ai-docs/THEME_HISTORY_GUIDE.md`に従ってテーマ開始履歴を記録する。
...
* **テーマ終了時：** 現在のテーマから移行する際は、`ai-docs/THEME_HISTORY_GUIDE.md`に従ってテーマ終了履歴を記録する
