...
テーマ専門家コンテキストは `ai-works/artifacts/{THEME_START_ID_テーマ名}/contexts/{ハートビートID}.md` に記録されています。
...
* 各ハートビートの活動は、`ai-works/artifacts/{THEME_START_ID_テーマ名}/histories/{ハートビートID}.md` として記録する
