...
##### パターン1: テーマ開始時の即座分割
**条件**: テーマ開始活動時に、テーマ内容が明らかにサブテーマ分割に適している場合

**フロー**:
1. **今回のハートビート**: メインテーマ開始活動（サブテーマ分割予定を記録）
2. **次のハートビート**: サブテーマ開始活動を実行

**例**: 
- テーマ内容に明確なステップや段階が記載されている
- 複数の独立した要素が明示されている
- 「段階的に進める」等の分割指示がある

##### パターン2: 内省後の分割
**条件**: テーマ運用中に内省活動でサブテーマ分割の必要性を認識した場合

**フロー**:
1. **内省ハートビート**: サブテーマ分割の必要性を判定・記録
2. **次のハートビート**: サブテーマ開始活動を実行
