...
## 成果物、関連ファイル
[このハートビートで作成または修正したファイルの**プロジェクトルートからの相対パス**を列挙(この活動ログファイル自身は除く)。例: ai-works/artifacts/20250115143000_laughter/20250115152000_thoughts_on_laughter.md]
...
### 3.5 厳格な制限事項
**禁止対象**: `ai-works/` 以外のファイル・ディレクトリの作成・編集・削除
